...
function keyboardUpdate() {
  ...
  const amountMoved = .5;
  // Controle de posição:
  if (keyboard.pressed("up")) camPos.add(new THREE.Vector3(0, 0, -amountMoved));
  if (keyboard.pressed("down"))
    camPos.add(new THREE.Vector3(0, 0, amountMoved));
  if (keyboard.pressed("left"))
    camPos.add(new THREE.Vector3(amountMoved, 0, 0));
  if (keyboard.pressed("right"))
    camPos.add(new THREE.Vector3(-amountMoved, 0, 0));
  if (keyboard.pressed("pageup"))
    camPos.add(new THREE.Vector3(0, amountMoved, 0));
  if (keyboard.pressed("pagedown"))
    camPos.add(new THREE.Vector3(0, -amountMoved, 0));

  // Controle do lookAt:
  if (keyboard.pressed("W"))
    camLook.add(new THREE.Vector3(0, 0, -amountMoved));
  if (keyboard.pressed("S"))
    camLook.add(new THREE.Vector3(0, 0, amountMoved));
  if (keyboard.pressed("D"))
    camLook.add(new THREE.Vector3(amountMoved, 0, 0));
  if (keyboard.pressed("A"))
    camLook.add(new THREE.Vector3(-amountMoved, 0, 0));
  if (keyboard.pressed("Q"))
    camLook.add(new THREE.Vector3(0, amountMoved, 0));
